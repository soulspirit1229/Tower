...
-(id) init {
    [super init];
    CCSprite *background =
    [CCSprite spriteWithFile:@"greenlevelscene.png"];
    [background setPosition:ccp(winSize.width/2,
                                winSize.height/2)];
    [self addChild:background z:0];
    
    sceneType = kGameLevel3;
    return self;
...
-(void) createBlocks {
    NSArray *images = [NSArray arrayWithObjects:@"001.png", @"002.png", @"003.png", @"004.png", @"009.png",@"010.png",@"011.png",@"012.png",@"101.png" ,@"201.png", nil];
